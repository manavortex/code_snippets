...
:convertFile
	...
	REM If you want to maximize your compression ratio with a fairly significant time tradeoff at larger file sizes, you can use the -o7 switch.
	REM optipng -o7 -strip all -preserve %filename%
